...
month.axis(start=31,stop=547,origin = 0, cex=0.8)
scot_title <- expression(bolditalic(Scotland))
title(main = scot_title)
...
lines(dat_swed$tag,fitted(b_swed),col="grey",lwd=2)
month.axis(start=26,stop=547,origin = 0, cex=0.8)
swed_title <- expression(bolditalic(Sweden))
title(main = swed_title)
...
lines(dat_dnk$tag,fitted(b_dnk),col="grey",lwd=2)
month.axis(start=26,stop=547,origin = 0, cex=0.8)
dnk_title <- expression(bolditalic(Denmark))
title(main = dnk_title)
...
lines(dat_nld$tag,fitted(b_nld),col="grey",lwd=2)
month.axis(start=26,stop=547,origin = 0, cex=0.8)
nld_title <- expression(bolditalic(Netherlands))
title(main = nld_title)
...
eng_title <- expression(bolditalic(England))
